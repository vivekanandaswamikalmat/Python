...
def create_dns_response(query_data, rcode):
    ...
    byte_stream = query_data[question_start:]
    null_byte_index = byte_stream.index(b'\x00') + 5
    question_section = byte_stream[:null_byte_index]
    # print "Question section (hex): %s" % question_section.encode('hex')
